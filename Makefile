...
minimal_multipart_parser_embedded.o: minimal_multipart_parser.c
	@$(CC) $(CFLAGS) $(LDFLAGS) -c -std=c99 -g0 -Os $^ -o $@
...
minimal_multipart_parser_with_debug.o: minimal_multipart_parser.c
	@$(CC) $(CFLAGS) $(LDFLAGS) -c -std=c99 -g2 -O0 $^ -o $@